...
@CucumberOptions(plugin = { // for report
		...
		strict = true, // why? it will check all feature scenario steps have corresponding automation
						// code or not
		// when? after developing step definition
		tags = { "@Smoke" } // only test we will mention in tag
)

public class phpLoginRunnerFile extends AbstractTestNGCucumberTests { 
	// AbstractTestNGCucumberTests to add TestNG
